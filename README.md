...
**Figure 4 – Attribute‑guided a (calm:3.4) cat image generation and its Cosine Similarity Radar Chart of the Attributes**
...
----------------------------------------------------------------------------------------------------
For the aggressive dragon, SDXL keeps the semantic attribute fixed but lets the art style redirect how that aggression is expressed visually. In the fantasy render (figure 5), rich colors, glowing eyes, and dynamic lighting activate CLIP directions associated with joyful, young, and rich, so the radar leans toward a triumphant, almost heroic kind of aggression. In the sketch version (figure 6), the same dragon is drawn in stark black‑and‑white with harsh lines and empty background, which boosts miserable, old, and sad scores instead—showing that the style token mainly controls the emotional framing (joyful vs. miserable atmosphere) while the underlying aggressive shape and pose of the subject remain constant.
![Screenshot_2026_02_22-7](https://github.com/user-attachments/assets/22e9ef20-5548-4a2e-9079-be4c6e470a3a)
**Figure 5 – Attribute‑guided a (aggressive:3.4) dragon in Fantasy (1.5) : creating with joyful expression**
![Screenshot_2026_02_22-9](https://github.com/user-attachments/assets/6cbb14fe-0149-4531-9a67-ecdc6fe0b490)
**Figure 6 – Attribute‑guided a (aggressive:3.4) dragon in Sketch (1.5) : creating with miserable expression**

----------------------------------------------------------------------------------------------------
This app is a robust, practical way to study prompt sensitivity, attribute entanglement, and internal behavior of text‑to‑image diffusion models.
## 🎥 How to use this app

[![Watch the walkthrough](https://img.youtube.com/vi/AHTA9MTOvFI/maxresdefault.jpg)](https://youtu.be/AHTA9MTOvFI)
